...
public:
  ...
  DungeonMonster__strongMonster(DungeonMonster  * input__item, DungeonMonster__Weapon  * input__weapon);
  ~DungeonMonster__strongMonster();
...
DungeonMonster__weakMonster  *DungeonMonster::Generate__weakMonster(void)
{
  ...
  DungeonMonster__weakMonster  *node = (new DungeonMonster__weakMonster);
  (((node)->item) = (this));
...
DungeonMonster__strongMonster  *DungeonMonster::Generate__strongMonster(void)
{
  ...
  DungeonMonster__strongMonster  *node = (new DungeonMonster__strongMonster);
  (((node)->item) = (this));
...
DungeonMonster__clubWeapon  *DungeonMonster::Generate__clubWeapon(void)
{
  ...
  DungeonMonster__clubWeapon  *node = (new DungeonMonster__clubWeapon);
  (((node)->item) = (this));
...
DungeonMonster__flailWeapon  *DungeonMonster::Generate__flailWeapon(void)
{
  ...
  DungeonMonster__flailWeapon  *node = (new DungeonMonster__flailWeapon);
  (((node)->item) = (this));
...
DungeonMonster__strongMonster::DungeonMonster__strongMonster(DungeonMonster  * input__item, DungeonMonster__Weapon  * input__weapon) : DungeonMonster__Monster((input__item)), weapon((input__weapon))
{
...
double DungeonMonster__ConfigLambda__32__50(const GiglConfig  & config);
double DungeonMonster__ConfigLambda__32__74(const GiglConfig  & config);
double DungeonMonster__ConfigLambda__33__48(const GiglConfig  & config);
double DungeonMonster__1__ConfigLambda__33__24(const GiglConfig  & config);
double DungeonMonster__ConfigLambda__32__50(const GiglConfig  & config)
{
...
void GenerateEasyRoomMonsters(DungeonMonster  * * list)
{

  {
    ...
    {
      (((list)[(i)]) = (new DungeonMonster((GiglConfig(0, 4, 0, (SizeVec{}), (VarPtrVec{}), (IndexVec{0, 1, 2, 3}), (FuncPtrVec{((FuncPtr)(&(DungeonMonster__ConfigLambda__32__50))), ((FuncPtr)(&(DungeonMonster__ConfigLambda__32__74))), ((FuncPtr)(&(DungeonMonster__ConfigLambda__33__48))), ((FuncPtr)(&(DungeonMonster__1__ConfigLambda__33__24)))}))))));
    }
  }
}
double DungeonMonster__ConfigLambda__40__50(const GiglConfig  & config);
double DungeonMonster__ConfigLambda__40__74(const GiglConfig  & config);
double DungeonMonster__ConfigLambda__41__48(const GiglConfig  & config);
double DungeonMonster__ConfigLambda__41__70(const GiglConfig  & config);
double DungeonMonster__ConfigLambda__40__50(const GiglConfig  & config)
{
...
void GenerateHardRoomMonsters(DungeonMonster  * * list)
{

  {
    for (signed int i = 0; ((i) < 10); ((i)++))
    {
      (((list)[(i)]) = (new DungeonMonster((GiglConfig(0, 4, 0, (SizeVec{}), (VarPtrVec{}), (IndexVec{0, 1, 2, 3}), (FuncPtrVec{((FuncPtr)(&(DungeonMonster__ConfigLambda__40__50))), ((FuncPtr)(&(DungeonMonster__ConfigLambda__40__74))), ((FuncPtr)(&(DungeonMonster__ConfigLambda__41__48))), ((FuncPtr)(&(DungeonMonster__ConfigLambda__41__70)))}))))));
    }
  }
}
