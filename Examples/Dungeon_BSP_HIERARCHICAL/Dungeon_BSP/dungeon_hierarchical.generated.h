...
public:
  ...
  void virtual Draw(signed int  is_padded) = 0;
...
public:
  BspDungeon__hDivide();
  BspDungeon__hDivide(BspDungeon  * input__item, BspDungeon__DungeonArea  * input__b_area, BspDungeon__DungeonArea  * input__t_area, Corridor  * input__corridor);
  ~BspDungeon__hDivide();
  double corrid_min;
  double corrid_max;
...
public:
  BspDungeon__vDivide();
  BspDungeon__vDivide(BspDungeon  * input__item, BspDungeon__DungeonArea  * input__l_area, BspDungeon__DungeonArea  * input__r_area, Corridor  * input__corridor);
  ~BspDungeon__vDivide();
  double corrid_min;
  double corrid_max;
...
public:
  BspDungeon__tArea();
  BspDungeon__tArea(BspDungeon  * input__item, Room  * input__room);
  ~BspDungeon__tArea();
  double room_min;
  Room  *room;
  double GetContactFromLeft(double  y);
...
public:
  ...
  BspDungeon__bossArea(BspDungeon  * input__item, BossRoom  * input__room);
  ~BspDungeon__bossArea();
  double room_min;
  BossRoom  *room;
  double GetContactFromLeft(double  y);
...
BspDungeon__hDivide  *BspDungeon::Generate__hDivide(const Range2D  & range, const Range1D  & cover_x, const Range1D  & cover_y, signed int  have_boss)
{
  ...
  BspDungeon__hDivide  *node = (new BspDungeon__hDivide);
  (((node)->item) = (this));
  (((node)->corrid_min) = (((double (*)(const GiglConfig  & , const Range2D  & , const Range1D  & , const Range1D  & , signed int  ))(((config).funcs)[9]))((config), (range), (cover_x), (cover_y), (have_boss))));
  (((node)->corrid_max) = (((double (*)(const GiglConfig  & , const Range2D  & , const Range1D  & , const Range1D  & , signed int  ))(((config).funcs)[10]))((config), (range), (cover_x), (cover_y), (have_boss))));
...
BspDungeon__vDivide  *BspDungeon::Generate__vDivide(const Range2D  & range, const Range1D  & cover_x, const Range1D  & cover_y, signed int  have_boss)
{
  ...
  BspDungeon__vDivide  *node = (new BspDungeon__vDivide);
  (((node)->item) = (this));
  (((node)->corrid_min) = (((double (*)(const GiglConfig  & , const Range2D  & , const Range1D  & , const Range1D  & , signed int  ))(((config).funcs)[11]))((config), (range), (cover_x), (cover_y), (have_boss))));
  (((node)->corrid_max) = (((double (*)(const GiglConfig  & , const Range2D  & , const Range1D  & , const Range1D  & , signed int  ))(((config).funcs)[12]))((config), (range), (cover_x), (cover_y), (have_boss))));
...
BspDungeon__tArea  *BspDungeon::Generate__tArea(const Range2D  & range, const Range1D  & cover_x, const Range1D  & cover_y, signed int  have_boss)
{
  ...
  BspDungeon__tArea  *node = (new BspDungeon__tArea);
  (((node)->item) = (this));
  (((node)->room_min) = (((double (*)(const GiglConfig  & , const Range2D  & , const Range1D  & , const Range1D  & , signed int  ))(((config).funcs)[13]))((config), (range), (cover_x), (cover_y), (have_boss))));
  
  {
    (((node)->room) = ((TermRoomGen)((range), (cover_x), (cover_y), ((node)->room_min), (wall_min))));
...
BspDungeon__bossArea  *BspDungeon::Generate__bossArea(const Range2D  & range, const Range1D  & cover_x, const Range1D  & cover_y, signed int  have_boss)
{
  ...
  BspDungeon__bossArea  *node = (new BspDungeon__bossArea);
  (((node)->item) = (this));
  (((node)->room_min) = (((double (*)(const GiglConfig  & , const Range2D  & , const Range1D  & , const Range1D  & , signed int  ))(((config).funcs)[14]))((config), (range), (cover_x), (cover_y), (have_boss))));
  
  {
    (((node)->room) = ((BossRoomGen)((range), (cover_x), (cover_y), ((node)->room_min), (wall_min))));
    (((node)->room_range) = (((node)->room)->range));
  }
  return (node);
}
...
BspDungeon__hDivide::BspDungeon__hDivide(BspDungeon  * input__item, BspDungeon__DungeonArea  * input__b_area, BspDungeon__DungeonArea  * input__t_area, Corridor  * input__corridor) : BspDungeon__DungeonArea((input__item)), corrid_min(), corrid_max(), b_area((input__b_area)), t_area((input__t_area)), corridor((input__corridor))
{
...
void BspDungeon__hDivide::Draw(signed int  is_padded)
{
...
BspDungeon__vDivide::BspDungeon__vDivide(BspDungeon  * input__item, BspDungeon__DungeonArea  * input__l_area, BspDungeon__DungeonArea  * input__r_area, Corridor  * input__corridor) : BspDungeon__DungeonArea((input__item)), corrid_min(), corrid_max(), l_area((input__l_area)), r_area((input__r_area)), corridor((input__corridor))
{
...
void BspDungeon__vDivide::Draw(signed int  is_padded)
{
...
BspDungeon__tArea::BspDungeon__tArea(BspDungeon  * input__item, Room  * input__room) : BspDungeon__DungeonArea((input__item)), room_min(), room((input__room))
{
...
void BspDungeon__tArea::Draw(signed int  is_padded)
{
...
BspDungeon__bossArea::BspDungeon__bossArea(BspDungeon  * input__item, BossRoom  * input__room) : BspDungeon__DungeonArea((input__item)), room_min(), room((input__room))
{
...
void BspDungeon__bossArea::Draw(signed int  is_padded)
{
...
const Range2D  &BspDungeon__ConfigLambda__234__54(const GiglConfig  & config);
double BspDungeon__ConfigLambda__234__67(const GiglConfig  & config);
double BspDungeon__ConfigLambda__234__77(const GiglConfig  & config);
double BspDungeon__ConfigLambda__234__87(const GiglConfig  & config);
signed int BspDungeon__ConfigLambda__234__97(const GiglConfig  & config);
double BspDungeon__ConfigLambda__236__34(const GiglConfig  & config, const Range2D  & range, const Range1D  & cover_x, const Range1D  & cover_y, signed int  have_boss);
double BspDungeon__ConfigLambda__236__50(const GiglConfig  & config, const Range2D  & range, const Range1D  & cover_x, const Range1D  & cover_y, signed int  have_boss);
double BspDungeon__ConfigLambda__236__69(const GiglConfig  & config, const Range2D  & range, const Range1D  & cover_x, const Range1D  & cover_y, signed int  have_boss);
double BspDungeon__ConfigLambda__237__34(const GiglConfig  & config, const Range2D  & range, const Range1D  & cover_x, const Range1D  & cover_y, signed int  have_boss);
double BspDungeon__ConfigLambda__237__50(const GiglConfig  & config, const Range2D  & range, const Range1D  & cover_x, const Range1D  & cover_y, signed int  have_boss);
double BspDungeon__ConfigLambda__237__69(const GiglConfig  & config, const Range2D  & range, const Range1D  & cover_x, const Range1D  & cover_y, signed int  have_boss);
double BspDungeon__ConfigLambda__238__32(const GiglConfig  & config, const Range2D  & range, const Range1D  & cover_x, const Range1D  & cover_y, signed int  have_boss);
double BspDungeon__ConfigLambda__238__61(const GiglConfig  & config, const Range2D  & range, const Range1D  & cover_x, const Range1D  & cover_y, signed int  have_boss);
double BspDungeon__ConfigLambda__239__35(const GiglConfig  & config, const Range2D  & range, const Range1D  & cover_x, const Range1D  & cover_y, signed int  have_boss);
double BspDungeon__ConfigLambda__239__60(const GiglConfig  & config, const Range2D  & range, const Range1D  & cover_x, const Range1D  & cover_y, signed int  have_boss);
const Range2D  &BspDungeon__ConfigLambda__234__54(const GiglConfig  & config)
{
...
BspDungeon  *GenerateDungeon(const Range2D  & whole_range, double  unit_min, double  unit_max, double  wall_min, double  have_boss_area)
{
  ...
  {
    return (new BspDungeon((GiglConfig(9, 15, ((sizeof(const Range2D *)) + ((sizeof(double *)) + ((sizeof(double *)) + ((sizeof(double *)) + ((sizeof(double *)) + ((sizeof(double *)) + ((sizeof(double *)) + ((sizeof(double *)) + (sizeof(double *)))))))))), (SizeVec{(sizeof(const Range2D *)), (sizeof(double *)), (sizeof(double *)), (sizeof(double *)), (sizeof(double *)), (sizeof(double *)), (sizeof(double *)), (sizeof(double *)), (sizeof(double *))}), (VarPtrVec{((VarPtr)(&((*((const Range2D * *)((malloc)((sizeof(const Range2D *)))))) = (&(whole_range))))), ((VarPtr)(&((*((double * *)((malloc)((sizeof(double *)))))) = (&(unit_min))))), ((VarPtr)(&((*((double * *)((malloc)((sizeof(double *)))))) = (&(unit_max))))), ((VarPtr)(&((*((double * *)((malloc)((sizeof(double *)))))) = (&(wall_min))))), ((VarPtr)(&((*((double * *)((malloc)((sizeof(double *)))))) = (&(have_boss_area))))), ((VarPtr)(&((*((double * *)((malloc)((sizeof(double *)))))) = (&(unit_min))))), ((VarPtr)(&((*((double * *)((malloc)((sizeof(double *)))))) = (&(unit_min))))), ((VarPtr)(&((*((double * *)((malloc)((sizeof(double *)))))) = (&(unit_min))))), ((VarPtr)(&((*((double * *)((malloc)((sizeof(double *)))))) = (&(unit_min)))))}), (IndexVec{0, 1, 2, 3, 4, 9, 10, 5, 11, 12, 6, 13, 7, 14, 8}), (FuncPtrVec{((FuncPtr)(&(BspDungeon__ConfigLambda__234__54))), ((FuncPtr)(&(BspDungeon__ConfigLambda__234__67))), ((FuncPtr)(&(BspDungeon__ConfigLambda__234__77))), ((FuncPtr)(&(BspDungeon__ConfigLambda__234__87))), ((FuncPtr)(&(BspDungeon__ConfigLambda__234__97))), ((FuncPtr)(&(BspDungeon__ConfigLambda__236__34))), ((FuncPtr)(&(BspDungeon__ConfigLambda__236__50))), ((FuncPtr)(&(BspDungeon__ConfigLambda__236__69))), ((FuncPtr)(&(BspDungeon__ConfigLambda__237__34))), ((FuncPtr)(&(BspDungeon__ConfigLambda__237__50))), ((FuncPtr)(&(BspDungeon__ConfigLambda__237__69))), ((FuncPtr)(&(BspDungeon__ConfigLambda__238__32))), ((FuncPtr)(&(BspDungeon__ConfigLambda__238__61))), ((FuncPtr)(&(BspDungeon__ConfigLambda__239__35))), ((FuncPtr)(&(BspDungeon__ConfigLambda__239__60)))})))));
  }
}
